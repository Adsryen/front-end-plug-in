    ...
    TimeAgo = (function () {
        ...
        TimeAgo.prototype.updateInterval = function () {
            ...
            if (this.$element.findAndSelf(this.options.selector).length > 0) {
                ...
                newestTimeSrc = this.$element.findAndSelf(this.options.selector).filter(filter).attr(
                    this.options.attr);
                newestTime = this.parse(newestTimeSrc);
                newestTimeInMinutes = this.getTimeDistanceInMinutes(newestTime);
                if (newestTimeInMinutes >= 0 && newestTimeInMinutes <= 44 && this.startInterval !==
                    60000) {
                    this.startInterval = 60000;
                    return this.restartTimer();
                } else if (newestTimeInMinutes >= 45 && newestTimeInMinutes <= 89 && this.startInterval !==
                    60000 * 22) {
                    this.startInterval = 60000 * 22;
                    return this.restartTimer();
                } else if (newestTimeInMinutes >= 90 && newestTimeInMinutes <= 2519 && this.startInterval !==
                    60000 * 30) {
        ...
        TimeAgo.prototype.distanceOfTimeInWords = function (absolutTime) {
            ...
            if (dim === 0) {
                ...
                return "" + this.options.lang.prefixes.about + " " + (Math.round(dim / 60)) + " " +
                ...
                return "" + this.options.lang.prefixes.about + " " + (Math.round(dim / 525600)) + " " +
                    this.options.lang.units.years;
            }
        };
